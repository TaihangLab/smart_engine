...
class CallPlayDetectorSkill(BaseSkill):
    ...
    DEFAULT_CONFIG = {
        ...
        "alert_definitions": [
            {
                "level": 1,
                "description": f"当检测到{AlertThreshold.LEVEL_1}名及以上人员打电话时触发。"
            },
            {
                "level": 2,
                "description": f"当检测到{AlertThreshold.LEVEL_2}名人员打电话时触发。"
            },
            {
                "level": 3,
                "description": f"当检测到{AlertThreshold.LEVEL_3}名人员打电话时触发。"
            },
            {
                "level": 4,
