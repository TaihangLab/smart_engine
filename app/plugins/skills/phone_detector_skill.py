...
class PhoneDetectorSkill(BaseSkill):
    ...
    DEFAULT_CONFIG = {
        ...
        "alert_definitions": [
            {
                "level": 1,
                "description": f"当检测到{AlertThreshold.LEVEL_1}个及以上手机设备时触发。"
            },
            {
                "level": 2,
                "description": f"当检测到{AlertThreshold.LEVEL_2}个手机设备时触发。"
            },
            {
                "level": 3,
                "description": f"当检测到{AlertThreshold.LEVEL_3}个手机设备时触发。"
            },
            {
                "level": 4,
