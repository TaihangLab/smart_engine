...
class CameraDetailResponse(BaseModel):
    ...
    # WVP通道信息字段
    gbDeviceId: Optional[str] = Field(None, description="国标设备ID")
    gbCivilCode: Optional[str] = Field(None, description="行政区划代码")
    gbManufacturer: Optional[str] = Field(None, description="厂商")
    gbModel: Optional[str] = Field(None, description="型号")
    gbIpAddress: Optional[str] = Field(None, description="IP地址")
    gbLongitude: Optional[float] = Field(None, description="经度")
    gbLatitude: Optional[float] = Field(None, description="纬度")
    createTime: Optional[str] = Field(None, description="创建时间")
    updateTime: Optional[str] = Field(None, description="更新时间")
    
    # 添加其他WVP通道字段
    gbOwner: Optional[str] = Field(None, description="所有者")
    gbBlock: Optional[str] = Field(None, description="区块")
    gbParental: Optional[int] = Field(None, description="是否有子设备")
    gbParentId: Optional[str] = Field(None, description="父设备ID")
    gbSafetyWay: Optional[int] = Field(None, description="安全通道")
    gbRegisterWay: Optional[int] = Field(None, description="注册方式")
    gbCertNum: Optional[str] = Field(None, description="证书号")
    gbCertifiable: Optional[int] = Field(None, description="证书认证")
    gbErrCode: Optional[int] = Field(None, description="错误代码")
    gbEndTime: Optional[str] = Field(None, description="结束时间")
    gbSecrecy: Optional[int] = Field(None, description="保密等级")
    gbPassword: Optional[str] = Field(None, description="密码")
    gpsAltitude: Optional[float] = Field(None, description="海拔")
    gpsSpeed: Optional[float] = Field(None, description="速度")
    gpsDirection: Optional[float] = Field(None, description="方向")
    gpsTime: Optional[str] = Field(None, description="GPS时间")
    gbBusinessGroupId: Optional[str] = Field(None, description="业务组ID")
    gbPtzType: Optional[int] = Field(None, description="云台类型")
    gbPositionType: Optional[int] = Field(None, description="位置类型")
    gbRoomType: Optional[int] = Field(None, description="房间类型")
    gbUseType: Optional[int] = Field(None, description="用途类型")
    gbSupplyLightType: Optional[int] = Field(None, description="补光类型")
    gbDirectionType: Optional[int] = Field(None, description="方向类型")
    gbResolution: Optional[str] = Field(None, description="分辨率")
    gbDownloadSpeed: Optional[str] = Field(None, description="下载速度")
    gbSvcSpaceSupportMod: Optional[int] = Field(None, description="空间支持模式")
    gbSvcTimeSupportMode: Optional[int] = Field(None, description="时间支持模式")
    recordPLan: Optional[int] = Field(None, description="录制计划")
    dataDeviceId: Optional[int] = Field(None, description="数据设备ID")
